  ...
  <div class="wallet-stats">
    ...
    <div v-else>
      ...
      <div class="wallet-actions">
        ...
        <router-link to="/assets/swap.send" class="wallet-actions-item swap-action" id="swap_action">
          <SwapIcon />
          Swap
        </router-link>
        <router-link to="/assets/receive" class="wallet-actions-item receive-action" id="receive_action">
          <ReceiveIcon />
          Receive
        </router-link>
      </div>
